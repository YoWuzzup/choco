    ...
    >
      {props.p.src ? (
        <div className="mb-5 w-full h-full">
          <img className="object-cover" src={props.p.src} alt="" />
        </div>
      ) : (
        <div
      ...
      <div className="flex flex-col justify-start items-start text-primary">
        <div className="font-bold hover:text-colorful">
          White Frosted Almond Bark
        </div>
        <div className="text-colorful">Price</div>
      </div>
